...
#ifndef vdp_ci_h_
#define vdp_ci_h_
#ifndef vdp_ci_COMMON_INCLUDES_
#define vdp_ci_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#endif                                 /* vdp_ci_COMMON_INCLUDES_ */

#include "vdp_ci_types.h"
#include <string.h>
...
#define vdp_ci_rtModel                 RT_MODEL_vdp_ci_T
...
#define rtB                            vdp_ci_B
#define BlockIO                        B_vdp_ci_T
#define rtX                            vdp_ci_X
#define ContinuousStates               X_vdp_ci_T
#define rtXdot                         vdp_ci_XDot
#define StateDerivatives               XDot_vdp_ci_T
#define tXdis                          vdp_ci_XDis
#define StateDisabled                  XDis_vdp_ci_T
#define rtY                            vdp_ci_Y
#define ExternalOutputs                ExtY_vdp_ci_T
#define rtP                            vdp_ci_P
#define Parameters                     P_vdp_ci_T
...
extern P_vdp_ci_T vdp_ci_P;

/* Block signals (default storage) */
extern B_vdp_ci_T vdp_ci_B;

/* Continuous states (default storage) */
extern X_vdp_ci_T vdp_ci_X;

/* Disabled states (default storage) */
extern XDis_vdp_ci_T vdp_ci_XDis;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_vdp_ci_T vdp_ci_Y;

/* Model entry point functions */
extern void vdp_ci_initialize(void);
extern void vdp_ci_output(void);
extern void vdp_ci_update(void);
extern void vdp_ci_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern vdp_ci_rtModel *vdp_ci(void);
...
extern RT_MODEL_vdp_ci_T *const vdp_ci_M;
